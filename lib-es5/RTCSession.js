...
module.exports = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(RTCSession, [{
    ...
    value: function _createLocalDescription(type, constraints) {
      ...
      .then(function (desc) {
        console.log('RTCSessionDescription returned: ', desc)
    ...
    value: function _sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream) {
      var _this21 = this;
      console.log('sendingInitialRequest')
      ...
      .then(function () {
        ...
        //let mstr = new MediaStream(stream);
        _this21._localMediaStream = stream
        console.log('--jssip--:MediaStream: ', stream)

        if (stream) {
          _this21._connection.addStream(stream, streamAdditionSucced, streamAdditionFail);
          console.log('--jssip--:stream added')
        } // TODO: should this be triggered here?

        // _this21._connection.onaddstream = function(){
        //   console.log('---JSSIP TRYNG----_this21._connecting(_this21._request)')
        //   _this21._connecting(_this21._request);
        //   console.log('----JSSIP-----_this21._connecting(_this21._request)')
        // }

        const streamAdditionSucced= function(){
          console.log('---JSSIP TRYNG----_this21._connecting(_this21._request)')
          _this21._connecting(_this21._request);
          console.log('----JSSIP-----_this21._connecting(_this21._request)')
        }

        const streamAdditionFail = function(){
          console.log('---JSSIP---Stream addition fail')
        }
